	...
	<div class="breadcumb-area">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="#">Advanced Programming Laboratory</a></li>
            </ol>
        </nav>
    </div>
 <section class="hero-area bg-img bg-overlay-2by5" style="background-image: url(img/c-img/apl.jpg);">
        <div class="container h-100">
            <div class="row h-100 align-items-center">
                <div class="col-12">
                    <!-- Hero Content -->
                    <div class="hero-content text-center">
                        <h2>Advanced Programming Laboratory</h2>
...
$con = mysqli_connect('localhost', 'root', '', 'LECTURES_FOR_UIU_STUDENT');
  ...
  $sql3 = "SELECT Department, Course_code, Course_title, Download_Link, Provide_by, Faculty FROM lectures where Course_title = 'Advanced Programming Laboratory' ";
