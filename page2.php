            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-popular-course mb-100 wow fadeInUp" data-wow-delay="250ms">
                        <img src="img/bg-img/algo.png" alt="">
                        <!-- Course Content -->
                        ...
                        <div class="seat-rating-fee d-flex justify-content-between">
                            ...
                            <div class="course-fee h-100">
                                <a href="algo.php" class="free">Free</a>
                            </div>
                        </div>
                    </div>
                </div>
				 <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-popular-course mb-100 wow fadeInUp" data-wow-delay="250ms">
                        <img src="img/bg-img/compiler.png" alt="">
                        <!-- Course Content -->
                        <div class="course-content">
                            <h4>Compiler</h4>
                            <div class="meta d-flex align-items-center">
                        ...
                        <div class="seat-rating-fee d-flex justify-content-between">
                            ...
                            <div class="course-fee h-100">
                                <a href="compiler.php" class="free">Free</a>
                            </div>
                        </div>
                    </div>
                </div>
				 <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-popular-course mb-100 wow fadeInUp" data-wow-delay="250ms">
                        <img src="img/bg-img/dsd .png" alt="">
                        <!-- Course Content -->
                        <div class="course-content">
                        ...
                        <div class="seat-rating-fee d-flex justify-content-between">
                            ...
                            <div class="course-fee h-100">
                                <a href="dsd.php" class="free">Free</a>
                            </div>
                        </div>
                    </div>
                </div>
              <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-popular-course mb-100 wow fadeInUp" data-wow-delay="250ms">
                        <img src="img/bg-img/graphics.png" alt="">
                        <!-- Course Content -->
                        <div class="course-content">
                        ...
                        <div class="seat-rating-fee d-flex justify-content-between">
                            ...
                            <div class="course-fee h-100">
                                <a href="graphics.php" class="free">Free</a>
                            </div>
                        </div>
                    </div>
                </div>
				 <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-popular-course mb-100 wow fadeInUp" data-wow-delay="250ms">
                        ...
                        <div class="seat-rating-fee d-flex justify-content-between">
                            ...
                            <div class="course-fee h-100">
                                <a href="datastruc.php" class="free">Free</a>
                            </div>
                        </div>
                    </div>
                </div>
				 <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-popular-course mb-100 wow fadeInUp" data-wow-delay="250ms">
                        ...
                        <div class="seat-rating-fee d-flex justify-content-between">
                            ...
                            <div class="course-fee h-100">
                                <a href="ca.php" class="free">Free</a>
                            </div>
                        </div>
                    </div>
                </div>
				<div class="col-12 col-md-6 col-lg-4">
                    <div class="single-popular-course mb-100 wow fadeInUp" data-wow-delay="250ms">
                        <img src="img/bg-img/soft.png" alt="">
                        <!-- Course Content -->
                        <div class="course-content">
                        ...
                        <div class="seat-rating-fee d-flex justify-content-between">
                            ...
                            <div class="course-fee h-100">
                                <a href="soft.php" class="free">Free</a>
                            </div>
                        </div>
                    </div>
                </div>
				<div class="col-12 col-md-6 col-lg-4">
                    <div class="single-popular-course mb-100 wow fadeInUp" data-wow-delay="250ms">
                        <img src="img/bg-img/discrete.png" alt="">
                        <!-- Course Content -->
                        <div class="course-content">
                            <h4>Discrete Mathemathics</h4>
                            <div class="meta d-flex align-items-center">
                                <a href="#">CSE Department</a>
                                <span><i class="fa fa-circle" aria-hidden="true"></i></span>
                            </div>
                        ...
                        <div class="seat-rating-fee d-flex justify-content-between">
                            ...
                            <div class="course-fee h-100">
                                <a href="discr.php" class="free">Free</a>
                            </div>
                        </div>
                    </div>
                </div>
				<div class="col-12 col-md-6 col-lg-4">
                    <div class="single-popular-course mb-100 wow fadeInUp" data-wow-delay="250ms">
                        <img src="img/bg-img/circuit.png" alt="">
                        <!-- Course Content -->
                         <div class="course-content">
                        ...
                        <div class="seat-rating-fee d-flex justify-content-between">
                            ...
                            <div class="course-fee h-100">
                                <a href="circuit.php" class="free">Free</a>
                            </div>
                        </div>
                    </div>
                </div>
