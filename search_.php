                    ...
                    <div class="classy-menu">
						...
						<div class="classynav">
                            ...
                            <div class="register-login-area">
                                <a class="btn btn-light action-button" role="button" href="admin.php" >Admin Panel</a>
...
<body>
 ...
 <section class="hero-area bg-img bg-overlay-2by5" style="background-image: url(img/blog-img/search.gif);">
...
$con = mysqli_connect('localhost', 'root', '', 'LECTURES_FOR_UIU_STUDENT');
  ...
  $sql3 = "SELECT Department, Course_code, Course_title, Download_Link, Provide_by, Faculty FROM lectures where Course_title Like '$val%' or Course_code Like '$val' or Provide_by like '$val%' ";
