        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-popular-course mb-100 wow fadeInUp" data-wow-delay="250ms">
                        ...
                        <div class="seat-rating-fee d-flex justify-content-between">
                            ...
                            <div class="course-fee h-100">
                                <a href="pr_man.php" class="free">Free</a>
                            </div>
                        </div>
                    </div>
                </div>
				 <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-popular-course mb-100 wow fadeInUp" data-wow-delay="250ms">
                        <img src="img/bg-img/phy.png" alt="">
                        <!-- Course Content -->
                        <div class="course-content">
                            <h4>Physics</h4>
                            <div class="meta d-flex align-items-center">
                        ...
                        <div class="seat-rating-fee d-flex justify-content-between">
                            ...
                            <div class="course-fee h-100">
                                <a href="physics.php" class="free">Free</a>
                            </div>
                        </div>
                    </div>
                </div>
				 <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-popular-course mb-100 wow fadeInUp" data-wow-delay="250ms">
                        <img src="img/bg-img/web.png" alt="">
                        <!-- Course Content -->
                        <div class="course-content">
                        ...
                        <div class="seat-rating-fee d-flex justify-content-between">
                            ...
                            <div class="course-fee h-100">
                                <a href="web.php" class="free">Free</a>
                            </div>
                        </div>
                    </div>
                </div>
              <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-popular-course mb-100 wow fadeInUp" data-wow-delay="250ms">
                        <img src="img/bg-img/dbms.png" alt="">
                        <!-- Course Content -->
                        <div class="course-content">
                        ...
                        <div class="seat-rating-fee d-flex justify-content-between">
                            ...
                            <div class="course-fee h-100">
                                <a href="database.php" class="free">Free</a>
                            </div>
                        </div>
                    </div>
                </div>
				 <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-popular-course mb-100 wow fadeInUp" data-wow-delay="250ms">
                        ...
                        <!-- Course Content -->
                        <div class="course-content">
                            <h4>Structure Programming Language</h4>
                            <div class="meta d-flex align-items-center">
                                <a href="#">CSE Department</a>
                                <span><i class="fa fa-circle" aria-hidden="true"></i></span>
                            </div>
                        ...
                        <div class="seat-rating-fee d-flex justify-content-between">
                            ...
                            <div class="course-fee h-100">
                                <a href="spl.php" class="free">Free</a>
                            </div>
                        </div>
                    </div>
                </div>
				 <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-popular-course mb-100 wow fadeInUp" data-wow-delay="250ms">
                        <img src="img/bg-img/sad.png" alt="">
                        <!-- Course Content -->
                        <div class="course-content">
                        ...
                        <div class="seat-rating-fee d-flex justify-content-between">
                            ...
                            <div class="course-fee h-100">
                                <a href="sad.php" class="free">Free</a>
                            </div>
                        </div>
                    </div>
                </div>
				<div class="col-12 col-md-6 col-lg-4">
                    <div class="single-popular-course mb-100 wow fadeInUp" data-wow-delay="250ms">
                        <img src="img/bg-img/eco.png" alt="">
                        <!-- Course Content -->
                        <div class="course-content">
                            <h4>Economics</h4>
                            <div class="meta d-flex align-items-center">
                        ...
                        <div class="seat-rating-fee d-flex justify-content-between">
                            ...
                            <div class="course-fee h-100">
                                <a href="eco.php" class="free">Free</a>
                            </div>
                        </div>
                    </div>
                </div>
				<div class="col-12 col-md-6 col-lg-4">
                    <div class="single-popular-course mb-100 wow fadeInUp" data-wow-delay="250ms">
                        ...
                        <div class="seat-rating-fee d-flex justify-content-between">
                            ...
                            <div class="course-fee h-100">
                                <a href="cloud.php" class="free">Free</a>
                            </div>
                        </div>
                    </div>
                </div>
				<div class="col-12 col-md-6 col-lg-4">
                    <div class="single-popular-course mb-100 wow fadeInUp" data-wow-delay="250ms">
                        <img src="img/bg-img/elec.jpg" alt="">
                        <!-- Course Content -->
                         <div class="course-content">
                            <h4>Electronics</h4>
                            <div class="meta d-flex align-items-center">
                        ...
                        <div class="seat-rating-fee d-flex justify-content-between">
                            ...
                            <div class="course-fee h-100">
                                <a href="electronics.php" class="free">Free</a>
                            </div>
                        </div>
                    </div>
                </div>
