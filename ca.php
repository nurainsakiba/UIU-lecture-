	...
	<div class="breadcumb-area">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="#">Computer Architecture</a></li>
            </ol>
        </nav>
    </div>
 <section class="hero-area bg-img bg-overlay-2by5" style="background-image: url(img/c-img/ca.jpeg);">
...
$con = mysqli_connect('localhost', 'root', '', 'LECTURES_FOR_UIU_STUDENT');
  ...
  $sql3 = "SELECT Department, Course_code, Course_title, Download_Link, Provide_by, Faculty FROM lectures where Course_title = 'Computer Architecture' ";
