        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-popular-course mb-100 wow fadeInUp" data-wow-delay="250ms">
                        ...
                        <div class="seat-rating-fee d-flex justify-content-between">
                            ...
                            <div class="course-fee h-100">
                                <a href="os.php" class="free">Free</a>
                            </div>
                        </div>
                    </div>
                </div>
				 <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-popular-course mb-100 wow fadeInUp" data-wow-delay="250ms">
                        ...
                        <div class="seat-rating-fee d-flex justify-content-between">
                            ...
                            <div class="course-fee h-100">
                                <a href="machine.php" class="free">Free</a>
                            </div>
                        </div>
                    </div>
                </div>
				 <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-popular-course mb-100 wow fadeInUp" data-wow-delay="250ms">
                        <img src="img/bg-img/es.png" alt="">
                        <!-- Course Content -->
                        <div class="course-content">
                            <h4>Elementary Calculus</h4>
                            <div class="meta d-flex align-items-center">
                                <a href="#">CSE Department</a>
                                <span><i class="fa fa-circle" aria-hidden="true"></i></span>
                            </div>
                        ...
                        <div class="seat-rating-fee d-flex justify-content-between">
                            ...
                            <div class="course-fee h-100">
                                <a href="elemen.php" class="free">Free</a>
                            </div>
                        </div>
                    </div>
                </div>
              <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-popular-course mb-100 wow fadeInUp" data-wow-delay="250ms">
                        <img src="img/bg-img/calcules.png" alt="">
                        <!-- Course Content -->
                        <div class="course-content">
                            <h4>Differential & Integral Calculus</h4>
                            <div class="meta d-flex align-items-center">
                                <a href="#">CSE Department</a>
                                <span><i class="fa fa-circle" aria-hidden="true"></i></span>
                            </div>
                        ...
                        <div class="seat-rating-fee d-flex justify-content-between">
                            ...
                            <div class="course-fee h-100">
                                <a href="math151.php" class="free">Free</a>
                            </div>
                        </div>
                    </div>
                </div>
				 <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-popular-course mb-100 wow fadeInUp" data-wow-delay="250ms">
                        <img src="img/bg-img/linear.png" alt="">
                        <!-- Course Content -->
                        <div class="course-content">
                            <h4>Linear Algebra & Partial Differential Equations</h4>
                            <div class="meta d-flex align-items-center">
                                <a href="#">CSE Department</a>
                                <span><i class="fa fa-circle" aria-hidden="true"></i></span>
                            </div>
                        ...
                        <div class="seat-rating-fee d-flex justify-content-between">
                            ...
                            <div class="course-fee h-100">
                                <a href="math183.php" class="free">Free</a>
                            </div>
                        </div>
                    </div>
                </div>
				 <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-popular-course mb-100 wow fadeInUp" data-wow-delay="250ms">
                        <img src="img/bg-img/fourier.png" alt="">
                        <!-- Course Content -->
                        <div class="course-content">
                            <h4>Fourier & Laplace Transformations</h4>
                            <div class="meta d-flex align-items-center">
                                <a href="#">CSE Department</a>
                                <span><i class="fa fa-circle" aria-hidden="true"></i></span>
                            </div>
                        ...
                        <div class="seat-rating-fee d-flex justify-content-between">
                            ...
                            <div class="course-fee h-100">
                                <a href="fourier.php" class="free">Free</a>
                            </div>
                        </div>
                    </div>
                </div>
				<div class="col-12 col-md-6 col-lg-4">
                    <div class="single-popular-course mb-100 wow fadeInUp" data-wow-delay="250ms">
                        <img src="img/bg-img/vector.png" alt="">
                        <!-- Course Content -->
                        <div class="course-content">
                            <h4>Coordinate Geometry & Vector Analysis</h4>
                            <div class="meta d-flex align-items-center">
                                <a href="#">CSE Department</a>
                                <span><i class="fa fa-circle" aria-hidden="true"></i></span>
                            </div>
                        ...
                        <div class="seat-rating-fee d-flex justify-content-between">
                            ...
                            <div class="course-fee h-100">
                                <a href="math201.php" class="free">Free</a>
                            </div>
                        </div>
                    </div>
                </div>
				<div class="col-12 col-md-6 col-lg-4">
                    <div class="single-popular-course mb-100 wow fadeInUp" data-wow-delay="250ms">
                        <img src="img/bg-img/micro.png" alt="">
                        <!-- Course Content -->
                        <div class="course-content">
                            <h4>Microprocessor & Interfacing</h4>
                            <div class="meta d-flex align-items-center">
                                <a href="#">CSE Department</a>
                                <span><i class="fa fa-circle" aria-hidden="true"></i></span>
                            </div>
                        ...
                        <div class="seat-rating-fee d-flex justify-content-between">
                            ...
                            <div class="course-fee h-100">
                                <a href="micro.php" class="free">Free</a>
                            </div>
                        </div>
                    </div>
                </div>
				<div class="col-12 col-md-6 col-lg-4">
                    <div class="single-popular-course mb-100 wow fadeInUp" data-wow-delay="250ms">
                        <img src="img/bg-img/java.png" alt="">
                        <!-- Course Content -->
                         <div class="course-content">
                        ...
                        <div class="seat-rating-fee d-flex justify-content-between">
                            ...
                            <div class="course-fee h-100">
                                <a href="java.php" class="free">Free</a>
                            </div>
                        </div>
                    </div>
                </div>
